...
const Sidebar = () => {
  return (
    <aside id="sidebar">
      ...
      <div class="sidebar-body ps ps--active-y" data-scroll="true">
        <nav class="navbar d-block p-0">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a
                href="404.html"
                class="nav-link d-flex align-items-center external"
              >
        ...
        <div class="ps__rail-y" style="top: 0px; height: 437px; right: 0px;">
          <div
            class="ps__thumb-y"
            tabindex="0"
      ...
      <div class="sidebar-foot">
        <a href="add-music.html" class="btn btn-primary d-flex">
          <div class="btn__wrap">
            <i class="ri-music-fill"></i> <span>Add Music</span>
          </div>
        </a>
      </div>
    </aside>
